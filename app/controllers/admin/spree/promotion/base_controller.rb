module Admin
  class Spree::Promotion::BaseController < Admin::ApplicationController
    include BelongsTo

    private

    def scoped_resource
      scoped_resource ||= resource_class.where(promotion: parent_page.resource)
    ...
    def new_resource
      resource_class.new(promotion: parent_page.resource)
    end
