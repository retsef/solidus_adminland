class Spree::Promotion::Actions::CreateAdjustmentDashboard < Spree::Promotion::Actions::BaseDashboard
  ...
  # Overwrite this method to customize how create adjustments are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(create_adjustment)
  #   "Spree::Promotion::Actions::CreateAdjustment ##{create_adjustment.id}"
  # end
end
