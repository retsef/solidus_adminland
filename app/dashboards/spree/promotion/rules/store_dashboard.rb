class Spree::Promotion::Rules::StoreDashboard < Spree::Promotion::Rules::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  ATTRIBUTE_TYPES = {
    ...
    promotion_rule_stores: Field::HasMany,
  ...
  #   "Spree::Promotion::Rules::Store ##{store.id}"
  # end
end
