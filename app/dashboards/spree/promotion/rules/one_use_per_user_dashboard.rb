class Spree::Promotion::Rules::OneUsePerUserDashboard < Spree::Promotion::Rules::BaseDashboard
  ...
  # Overwrite this method to customize how one use per users are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(one_use_per_user)
  #   "Spree::Promotion::Rules::OneUsePerUser ##{one_use_per_user.id}"
  # end
end
