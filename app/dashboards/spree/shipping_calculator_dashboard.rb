class Spree::ShippingCalculatorDashboard < Spree::BaseDashboard
  def self.model
    ::Spree::Calculator
  end
  ...
  ATTRIBUTE_TYPES = {
    id: Field::Number,
    type: Field::Select.with_options(collection: calculators.map { |rule| [rule.model_name.human, rule.name] }),
