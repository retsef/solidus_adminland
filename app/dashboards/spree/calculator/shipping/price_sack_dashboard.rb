class Spree::Calculator::Shipping::PriceSackDashboard < Spree::Calculator::Shipping::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  ATTRIBUTE_TYPES = {
    ...
    preferred_minimal_amount: Field::Number,
    preferred_normal_amount: Field::Number,
    preferred_discount_amount: Field::Number,
