class Spree::Calculator::Shipping::BaseDashboard < Spree::CalculatorDashboard
  ...
  ATTRIBUTE_TYPES = {
    id: Field::Number,
    type: Field::Select.with_options(collection: shipping_methods.map { |rule| [rule.model_name.human, rule.name] }),
